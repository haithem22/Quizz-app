...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new DownloadQuestion().execute(Constants.BASE_URL + Constants.URL_QUESTION_BY_TAG + category);
    ...
    class DownloadQuestion extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (answers_length > 0)
                    player1_view.setText(answerList.get(0).getResponse());
                if (answers_length > 1)
                    player2_view.setText(answerList.get(1).getResponse());
                if (answers_length > 2)
                    player3_view.setText(answerList.get(2).getResponse());
                if (answers_length > 3)
                    player4_view.setText(answerList.get(3).getResponse());
